...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder().title("API - blogpessoal").description("Projeto integrador API Spring - blogpessoal")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/kevinsousa0")
				.contact(contact()).build();
	}

	private static Contact contact() {

		return new Contact("blogpessoal", "https://github.com/kevinsousa0", "blogpessoal@gmail.com");
